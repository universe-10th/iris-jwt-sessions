...
// Yes, this file is ported as well, alongside memdb.go and provider.
...
type (
	// JWTSession should expose the JWTSessions's end-user API.
...
func (s *JWTSession) peekFlashMessage(key string) (*flashMessage, bool) {
	s.mu.RLock()
...
func (s *JWTSession) set(key string, value interface{}, immutable bool) {
